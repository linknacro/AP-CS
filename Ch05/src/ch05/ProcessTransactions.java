...
public class ProcessTransactions {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < days; i++) {
            ...
            System.out.println("Total amount of deposits: " + Account.getAmtDeposits());
            System.out.println("");
            //Print amount of withdrawals
            System.out.println("Total amount of withdrawals: " + Account.getAmtWithdrals());
            System.out.println("");
            //Print total number of deposits
            System.out.println("Total number of deposits: " + Account.getNumDeposits());
            System.out.println("");
            //Print total number of withdrawals
            System.out.println("Total number of withdrals: " + Account.getNumWithdrals());
            System.out.println("");
        }
    }
}
